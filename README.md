...
const jozyipv6 = {
  ...
  techStack: {
    ...
    backend: ["Node.js", "NestJS", "GraphQL", "tRPC", "Prisma"],
    database: ["PostgreSQL", "MongoDB", "Redis", "Supabase"],
    cloud: ["AWS", "Docker", "Kubernetes", "Terraform", "GitHub Actions"],
    tools: ["Git", "Linux", "Nginx", "Jest", "Playwright"]
  },
  
  architecture: ["Microservices", "Serverless", "Event-Driven", "RESTful APIs"],
  principles: ["Clean Code", "SOLID", "DRY", "TDD", "CI/CD"]
};
```
...
<sub>Building scalable solutions, one commit at a time | Always learning, always growing</sub>

</div>

<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=12,18,20&height=100&section=footer" />
